...
public class MainMenuScreen extends Screen {
    ...
    public void load(MainFrame mainFrame) {
        NormalButton gameButton = new NormalButton("Game", 5, new Dimension(40, 10)) {
            @Override
            public void clicked() {
                Controller.switchScreen(new GameScreen());
            }
        };
        gameButton.coordinates = new Coordinates(30, 5);
        addDisplayComponent(gameButton, mainFrame.panel);

        NormalButton settings = new NormalButton("Settings", 5, new Dimension(40,10)) {
            @Override
            public void clicked() {
                Controller.switchScreen(new SettingsScreen());
            }
        };
        settings.coordinates = new Coordinates(30,20);
